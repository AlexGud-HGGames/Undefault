...
/// <summary>
/// GsiHost <see cref="IPlaybackEventRecorder"/> that persists confirmed Spotify playback state
...
/// (<c>SpotifyPlaybackControlCoordinator</c> -&gt; <c>IPlaybackEventRecorder</c> -&gt;
/// <c>TimelineCaptureService</c> -&gt; <c>GsiProcessingService</c> -&gt; <c>RulesEngine</c> -&gt;
/// <c>SpotifyControlProfileAction</c> -&gt; <c>ISpotifyPlaybackControl</c> -&gt; coordinator). By deferring
